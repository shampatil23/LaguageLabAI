...
const mockClasses = [
  'SEM-1 - Vocabulary',
  'SEM-1-A - Unit I Vocabulary',
  'SEM-1-A - Unit I Vocabulary Collocations',
  'SEM-1-A - Unit I Vocabulary Homophones',
  'SEM-1-A - Unit I Vocabulary PREFIX AND SUFFIX',
  'SEM-1-A - Unit I Vocabulary Synonyms & Antonyms',
  'SEM-1-A - Unit II Paragraph Writing',
  'SEM-1-A - Unit III Comprehension',
  'SEM-1-A - Unit IV Communicative Language'
];
...
const mockLessons = [
  ...
  { id: '2', name: 'VOWEL-DIP-1_HTM', type: 'HTML' },
  { id: '3', name: 'VOWEL-DIP-1_MEDIA', type: 'Video' },
  { id: '4', name: 'VOWEL-DIP-2_HTM', type: 'HTML' },
  { id: '5', name: 'VOWEL-DIP-2_MEDIA', type: 'Video' },
  { id: '6', name: 'VOWEL-DIP-3_HTM', type: 'HTML' },
  { id: '7', name: 'VOWEL-DIP-4_HTM', type: 'HTML' }
];
...
fs.writeFileSync('src/pages/Assessments.tsx', content);
